...
namespace Project.UI.MainUI
{
    public class NextTileChoiceDisplay : MonoBehaviour
    {
        ...
        public void DisplayChoices(Choice<TileData> tileChoice)
        {
            ...
            itemChoiceDisplay01.DisplayTile(tileChoice.GetItem(0), 1);
            ...
            itemChoiceDisplay02.DisplayTile(tileChoice.GetItem(1), 2);
            ...
            itemChoiceDisplay03.DisplayTile(tileChoice.GetItem(2), 3);
