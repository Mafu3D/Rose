...
namespace Project.UI.MainUI
{
    public class TreasureChoiceDisplay : MonoBehaviour
    {
        ...
        public void DisplayChoices(TreasureChoice treasureChoice)
        {
            ...
            itemChoiceDisplay01.DisplayItem(treasureChoice.GetItemData(0), 1);
            ...
            itemChoiceDisplay02.DisplayItem(treasureChoice.GetItemData(1), 2);
            ...
            itemChoiceDisplay03.DisplayItem(treasureChoice.GetItemData(2), 3);
