...
{
    public class DrawCard : State
    {
        public DrawCard(StateMachine stateMachine) : base(stateMachine) { }
        ...
        private void Continue()
        {
            ...
            StateMachine.SwitchState(new ResolvingEffects(new ActivateTiles(StateMachine), StateMachine));
        }
    }
}